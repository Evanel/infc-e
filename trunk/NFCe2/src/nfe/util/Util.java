 ...
 * 
             * ATENCAO !!!!!!!!
             * ---------------------------------------------------------------
             * Para pegar valores de Child em arquivos que tem namespace, este
             * deve ser passado, obrigatoriamente, nas funcoes que retornam
             * chield e valores. Se isso nao for feito retornarah sempre null
             * 
             *
            
            File f = new File("C:/teste_ler.xml");
            ...
            System.out.println("Teste: " + root.getName() );
            
            System.out.println("tpAmb: " + root.getChild("tpAmb", root.getNamespace()).getValue() );
            
            Element e = root.getChild("chNFe", root.getNamespace());
            System.out.println("chNFe: " + e.getValue());
            
            Element p = root.getChild("protNFe", root.getNamespace());

            
            System.out.println("protNFe.infProt.xMotivo: " + p.getChild("infProt", root.getNamespace()).getChildText("xMotivo", root.getNamespace()) );
            System.out.println("protNFe.infProt.digVal: " + p.getChild("infProt", root.getNamespace()).getChildText("digVal", root.getNamespace()) );
