 ...
 * @author Ivan Vargas
 *
 * Exemplo basico de Emissao de NFC-e utilizando o Projeto iNFC-e.
 * Este teste foi realizado em ambiente desktop, por isso utilizo JOptionPane para
 * setar algumas configuracoes, porem estes parametros podem ser passados para o 
 * sistema da forma que voce desejar.
 * Observe que a NFC-e eh gerada pela classe NFe2 e enviada pela 
 * classe Emissor.
 */
    ...
    public static void Enviar() {
        ...
        {       
            ...
            */
            ...
            /* Aqui e realizada a Emissao da NFC-e */
            Emissor e = new Emissor();
            e.setNFe(nfe2);
            e.setLote(nLote);
            boolean r = e.EmitirNotaFiscal();

			/* retorno a resposta dos WebServices para o usuario */
            if (r)
            {
